...
import { getUserExpenses, addExpense, updateExpense, getExpenseSummary, deleteExpense,getExpenseById } from "../controllers/expense.controller.js";
...
expenseRouter.put('/:expenseId',verifyToken,updateExpense);
